...
export const binPayouts: Record<RowCount, Record<RiskLevel, number[]>> = {
  ...
  15: {
    [RiskLevel.LOW]: [10000000000,10000000000,10000000000,10000000000,10000000000,10000000000,10000000000,10000000000,10000000000,10000000000,10000000000,10000000000,10000000000,10000000000,10000000000,10000000000],
